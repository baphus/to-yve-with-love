...
export function LoveLettersSection() {
  ...
  return (
    <section id="love-letters" className="relative w-full py-20 lg:py-32 bg-primary/20 overflow-hidden">
      ...
      <Image src="/stickers/sticker8.png" alt="sticker" width={80} height={80} className="sticker top-[50%] right-[5%] z-20" style={{ animationDelay: '0.9s' }} />
      <Image src="/stickers/sticker9.png" alt="sticker" width={68} height={68} className="sticker bottom-[25%] right-[20%] z-20" style={{ animationDelay: '1.1s' }} />
      <Image src="/stickers/sticker10.png" alt="sticker" width={50} height={50} className="sticker top-[55%] left-[15%] z-20" style={{ animationDelay: '1.3s' }} />
